...
const NewLogin = resolve => require(['@/views/NewLogin'], resolve)
const NewDashboard = resolve => require(['@/YDemo/Dashboard/NewDashboard'], resolve)
const OperatingHome =resolve => require(['@/YDemo/Operating/home'],resolve)
